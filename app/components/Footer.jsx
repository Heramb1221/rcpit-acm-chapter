                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-6">
                    <div className="col-span-2 sm:col-span-2 md:col-span-1 gap-6 sm:gap-8">
                        ...
                        <div className="flex justify-between gap-4 mt-2 pr-40 pl-6">
                            ...
                            <a href="https://www.instagram.com/acm.rcpit?igsh=ZnZqdXNpb2VhY2J3&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-indigo-600">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-indigo-600">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
